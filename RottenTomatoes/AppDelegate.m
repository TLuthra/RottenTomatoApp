...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    navigationController.navigationBar.barTintColor = [UIColor darkTextColor];
    [[UINavigationBar appearance] setTitleTextAttributes:@{NSForegroundColorAttributeName : [UIColor colorWithRed:238/255.0 green:188/255.0 blue:0/255.0 alpha:1]}];
    self.window.rootViewController = navigationController;
    [self.window setTintColor:[UIColor colorWithRed:238/255.0 green:188/255.0 blue:0/255.0 alpha:1]];
